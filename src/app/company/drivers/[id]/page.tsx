  ...
  const modules = [
    {
      ...
      href: `/company/documents?driver=${driver.id}`,
    },
    {
      icon: ShieldCheck,
      label: "Screening (PSP/MVR)",
      value: `${driver.screenings.length} report(s)`,
      href: `/company/screening?driver=${driver.id}`,
    },
    {
      icon: FlaskConical,
      label: "Drug Tests",
      value: `${driver.drugTests.length} test(s)`,
      href: `/company/drug-tests?driver=${driver.id}`,
    },
    {
      icon: ClipboardCheck,
      label: "Clearinghouse",
      value: `${driver.clearinghouseQueries.length} query(ies)`,
      href: `/company/clearinghouse?driver=${driver.id}`,
    },
    {
      icon: CalendarClock,
      label: "Orientation",
      value: `${driver.appointments.length} appt(s)`,
      href: `/company/appointments?driver=${driver.id}`,
    },
    {
      icon: Truck,
      label: "Equipment",
