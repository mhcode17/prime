...
import { AddTruckForm, TruckRowActions } from "./truck-ui";
...
export default async function TrucksPage() {
  ...
  return (
    <div>
      <PageHeader title="Trucks" description="Manage your fleet of trucks." />
                ...
                <tbody>
                  {trucks.map((t) => (
                    <tr key={t.id} className="border-b border-slate-50 last:border-0">
                      ...
                      <td className="px-5 py-3">
                        <TruckRowActions id={t.id} status={t.status} />
                      </td>
                    </tr>
                  ))}
                  {trucks.length === 0 && (
                    <tr>
                      <td colSpan={5} className="px-5 py-10 text-center text-slate-500">
                        No trucks yet. Add one on the right.
                      </td>
                    </tr>
                  )}
                </tbody>
